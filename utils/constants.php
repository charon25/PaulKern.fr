...
// Constantes page "Général"
	$GEN_PREFIX = 'general_';
	$GEN_PRES_TEXT = $GEN_PREFIX . 'presentation-text';
	$GEN_LINK_MAIL = $GEN_PREFIX . 'mail';
	$GEN_LINK_LINKEDIN = $GEN_PREFIX . 'linkedin';
	$GEN_LINK_GITHUB = $GEN_PREFIX . 'github';
